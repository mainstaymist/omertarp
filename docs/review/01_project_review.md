...
| Q-10 | Weapons base: custom SWEPs vs. adapting an existing base for the small period arsenal (BA §27) | M14+ | **RESOLVED → D-039**: custom modular base; a weapon is one data registration |
...
| Q-15 | Justice loop design selection | M18 | **RESOLVED → D-040**: The Ledger |
