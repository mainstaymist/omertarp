...
| `sound/omertarp/injury/leg-break-{1,2,3}.wav` | 0.43 s / 0.58 s / 0.36 s | 236 KB (3 files) | A leg breaking in a fall — one of the three at random, played at `injury.leg_break_volume` because the files are loud (`modules/injury`) |
